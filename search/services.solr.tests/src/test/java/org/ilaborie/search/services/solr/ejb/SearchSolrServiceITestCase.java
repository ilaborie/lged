...
import org.ilaborie.search.services.solr.test.MockIndexableElement;
import org.ilaborie.search.services.solr.test.MockService;
...
public class SearchSolrServiceITestCase {
	...
	public static Archive<?> buildArchive() {
		...
		ejb.addClass(LoggerProducer.class);
