...
import org.ilaborie.search.commons.services.ISearchService;
import org.ilaborie.search.commons.utils.functions.FileToIndexableFile;
import org.ilaborie.search.commons.utils.predicates.FilesPredicates;
import org.ilaborie.search.services.solr.utils.LoggerProducer;
...
public class IndexableFileITestCase {
	...
	public static Archive<?> buildArchive() {
		...
		// Add Tika
		archive.addAsLibraries(resolver.artifact("org.apache.tika:tika-parsers")
		        .resolveAsFiles());
